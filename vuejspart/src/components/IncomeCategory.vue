<template>
  <div class="col-4">
      <div class="text-left">
        <div class="text-left">
          <h1><span style="color:green"> <strong>Income</strong> </span> Category</h1>
          <div>
            <input class="form-control" v-model="category" placeholder="Add Category" @keyup.enter="addCategory">
            <button type="button" class="btn btn-outline-success form-control" @click.stop="addCategory">Add Category</button>
          </div>
